...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.zmSlider = QtGui.QSlider(self.groupBox_2)
        self.zmSlider.setGeometry(QtCore.QRect(30, 70, 160, 29))
        self.zmSlider.setMinimum(100)
        self.zmSlider.setMaximum(1000)
        self.zmSlider.setSliderPosition(100)
        self.zmSlider.setOrientation(QtCore.Qt.Horizontal)
        self.zmSlider.setObjectName(_fromUtf8("zmSlider"))
        self.label_3 = QtGui.QLabel(self.groupBox_2)
        self.label_3.setGeometry(QtCore.QRect(80, 40, 66, 17))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.zmSlider.raise_()
        self.label_3.raise_()
        ...
        self.gridLayout_3.addWidget(self.playBtn, 1, 1, 1, 1)
